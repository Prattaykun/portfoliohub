  ...
  <div class="body-wrap">
    ...
    <div class="left-col">
      ...
      <div class="sec">
        ...
        ${contact.phone ? `<div class="contact-row"><img src="https://img.icons8.com/?size=100&id=9730&format=png&color=000000" /><div><div class="contact-label">Phone</div>${renderPhoneLink(contact.phone, escapeHtml)}</div></div>` : ''}
        ${contact.email ? `<div class="contact-row"><img src="https://img.icons8.com/?size=100&id=12623&format=png&color=000000" /><div><div class="contact-label">Email</div>${renderEmailLink(contact.email, escapeHtml)}</div></div>` : ''}
        ...
        ${contact.linkedin ? `<div class="contact-row"><img src="https://www.google.com/s2/favicons?domain=linkedin.com&sz=128" /><div><div class="contact-label">LinkedIn</div>${renderLinkedInLink(contact.linkedin, escapeHtml)}</div></div>` : ''}
        ${contact.github ? `<div class="contact-row"><img src="https://www.google.com/s2/favicons?domain=github.com&sz=128" /><div><div class="contact-label">GitHub</div>${renderGitHubLink(contact.github, escapeHtml)}</div></div>` : ''}
        ${Array.isArray(contact.other_links) ? contact.other_links.map((link: any) => {
          ...
          return `<div class="contact-row">${renderOtherLinkIconImg(link, escapeHtml)}<div><div class="contact-label">${escapeHtml(name)}</div>${renderWebLink(link.url, displayUrl, escapeHtml)}</div></div>`
        }).join('') : ''}
      </div>` : ''}
