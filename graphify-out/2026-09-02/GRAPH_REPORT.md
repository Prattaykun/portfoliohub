...
## Corpus Check
- 123 files · ~87,193 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 719 nodes · 1074 edges · 92 communities (38 shown, 54 thin omitted)
...
5. `POST()` - 11 edges
6. `SelectedItems` - 11 edges
7. `renderDeclaration()` - 11 edges
8. `/graphify` - 11 edges
9. `POST()` - 10 edges
10. `CVSectionToggles` - 10 edges
...
- `POST()` --calls--> `withPortfolioContactLink()`  [EXTRACTED]
  app/api/generate-cv/route.ts → lib/server/withPortfolioContactLink.ts
...
Cohesion: 0.10
Nodes (35): generatePDFWithBrowserless(), POST(), RequestPayload, supabaseAdmin, uploadToCloudinary(), POST(), supabaseAdmin, POST() (+27 more)

### Community 3 - "resumeTemplates.ts"
Cohesion: 0.14
Nodes (27): RequestPayload, PickerItem, Props, extractAch(), ResumeWizard(), WizardProps, Props, Props (+19 more)
...
Cohesion: 0.09
Nodes (28): About, Certificate, CertificateSkill, CompanyExperience, Contact, ContactLink, Education, escapeHtml() (+20 more)
...
Cohesion: 0.18
Nodes (11): eslint-config-next, @eslint/eslintrc, devDependencies, eslint-config-next, @eslint/eslintrc, postcss-nesting, tailwindcss, @types/react-dom (+3 more)
...
Cohesion: 0.29
Nodes (7): cloudinary, groq-sdk, dependencies, cloudinary, groq-sdk, react-dom, react-dom
